...
| Terminal screen | Child lifecycle, VTE search state, background handling, scrolling, VTE highlighting of the same patterns, and clipboard primary selection | In progress |
