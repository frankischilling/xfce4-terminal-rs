...
| Preferences | Property names, types, defaults, Xfconf updates, legacy import, and accelerators | In progress: local proof passes; protected frozen-reference CI pending |
